srcdir = /usr/include/php/ext/zhangzy
builddir = /usr/include/php/ext/zhangzy
top_srcdir = /usr/include/php/ext/zhangzy
top_builddir = /usr/include/php/ext/zhangzy
...
RE2C = re2c
AWK = awk
ZHANGZY_SHARED_LIBADD =
shared_objects_zhangzy = zhangzy.lo
PHP_PECL_EXTENSION = zhangzy
PHP_MODULES = $(phplibdir)/zhangzy.la
PHP_ZEND_EX =
...
prefix = /usr
phplibdir = /usr/include/php/ext/zhangzy/modules
